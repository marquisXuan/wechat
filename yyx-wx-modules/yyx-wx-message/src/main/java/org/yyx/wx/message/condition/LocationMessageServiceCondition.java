...
public class LocationMessageServiceCondition implements Condition {
    ...
    /**
     * LocationMessageServiceCondition 日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(LocationMessageServiceCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        try {
            ...
            for (int i = 0; i < interfaceSubClass.size(); i++) {
                ...
                if (o instanceof LocationMessageHandlerProxy) {
                    return false;
                }
            }
        } catch (IOException e) {
