 ...
 */
@Component
public class ShortVideoMessageServiceCondition implements Condition {

    /**
     * ShortVideoMessageServiceCondition 日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ShortVideoMessageServiceCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        for (int i = 0; i < interfaceSubClass.size(); i++) {
            ...
            if (o instanceof ShortVideoMessageHandlerProxy) {
                return false;
            }
        }
        return true;
