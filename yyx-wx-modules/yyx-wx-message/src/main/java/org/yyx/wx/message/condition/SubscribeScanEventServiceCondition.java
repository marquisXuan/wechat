 ...
 */
@Component
public class SubscribeScanEventServiceCondition implements Condition {

    /**
     * SubscribeScanEventServiceCondition 日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(SubscribeScanEventServiceCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        try {
            ...
            for (int i = 0; i < interfaceSubClass.size(); i++) {
                ...
                if (o instanceof SubscribeScanEventHandlerProxy) {
                    return false;
                }
            }
        } catch (IOException e) {
