 ...
 */
@Component
public class UnSubscribeEventServiceCondition implements Condition {


    /**
     * UnSubscribeEventServiceCondition 日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(UnSubscribeEventServiceCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        try {
            ...
            for (int i = 0; i < interfaceSubClass.size(); i++) {
                ...
                if (o instanceof UnSubscribeEventHandlerProxy) {
                    return false;
                }
            }
        } catch (IOException e) {
