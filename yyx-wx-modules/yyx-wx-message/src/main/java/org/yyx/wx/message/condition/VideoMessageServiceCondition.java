...
public class VideoMessageServiceCondition implements Condition {
    ...
    /**
     * VideoMessageServiceCondition 日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(VideoMessageServiceCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        for (int i = 0; i < interfaceSubClass.size(); i++) {
            ...
            if (o instanceof VideoMessageHandlerProxy) {
                return false;
            }
        }
        return true;
