 ...
 */
@Service
public class DemoLinkMessageServiceImpl implements LinkMessageHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoLinkMessageServiceImpl.class);
