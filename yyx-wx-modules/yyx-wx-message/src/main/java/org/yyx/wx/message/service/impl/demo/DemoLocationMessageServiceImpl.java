 ...
 */
@Service
public class DemoLocationMessageServiceImpl implements LocationMessageHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoLocationMessageServiceImpl.class);
