 ...
 */
@Service
public class DemoShortVideMessageServiceImpl implements ShortVideoMessageHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoShortVideMessageServiceImpl.class);
