 ...
 */
@Service
public class DemoUnSubscribeEventServiceImpl implements UnSubscribeEventHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoUnSubscribeEventServiceImpl.class);
