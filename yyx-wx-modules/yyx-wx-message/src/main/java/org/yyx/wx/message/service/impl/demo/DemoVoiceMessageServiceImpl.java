 ...
 */
@Service
public class DemoVoiceMessageServiceImpl implements VoiceMessageHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoVoiceMessageServiceImpl.class);
    ...
    public BaseMessageResponse dealMessage(BaseMessageAndEventRequestAndResponse baseMessageAndEventRequest) {
        ...
        textMessageResponse.setContent("[DEMO] 叶云轩自定义文本回复。\n你发的是一条语音消息：" +
                videoMessageRequest.getMediaID());
        // endregion
