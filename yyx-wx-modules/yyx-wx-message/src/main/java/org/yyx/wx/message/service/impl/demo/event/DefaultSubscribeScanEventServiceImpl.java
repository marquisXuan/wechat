 ...
 */
@Service
public class DefaultSubscribeScanEventServiceImpl implements SubscribeScanEventHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultSubscribeScanEventServiceImpl.class);
