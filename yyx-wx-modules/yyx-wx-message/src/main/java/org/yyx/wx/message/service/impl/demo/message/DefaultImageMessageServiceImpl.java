 ...
 */
@Service
public class DefaultImageMessageServiceImpl implements ImageMessageHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultImageMessageServiceImpl.class);
