 ...
 */
@Service
public class DefaultVideoMessageServiceImpl implements VideoMessageHandlerProxy {

    /**
     * DemoServiceImpl日志输出
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultVideoMessageServiceImpl.class);
